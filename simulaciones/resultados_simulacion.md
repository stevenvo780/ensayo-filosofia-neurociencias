...
- **Número de neuronas:** 10,000
- **Actividad en la red biológica (esparcimiento):** 1% (100 neuronas activas)
- **Canales de señalización simulación biológica:** 3 (Eléctrica, Glutamatergica, GABAergica) + Modulador global (Dopamina).
- **Sustrato de ejecución digital:** CPU Intel/AMD (Potencia estimada: 100.0W)
...
| :--- | :---: | :---: | :---: |
| **Tiempo de Ejecución** | 16.8797 ms | 0.3524 ms | ~2.0000 ms |
| **Operaciones (FLOPs)** | 200,000,000 | 1,520,000 | N/A (Física continua) |
| **Energía Consumida (PC)** | 1.69e+00 Joules | 3.52e-02 Joules | ~4.65e-09 Joules (Proporcional 20W)<br>~1.00e-10 Joules (Física sináptica) |
