...
La auditoría del código muestra tres cosas. κ=0 no es un resultado: en esa rama el recurso se repone por estipulación y el parámetro lesionado no aparece en la ecuación —envenenarlo con valores absurdos sigue devolviendo cero—; es una identidad aritmética. κ≈0,88 tampoco es un descubrimiento: tiene forma cerrada y recorre todo el rango [0,1] al mover un solo parámetro. Y lo que κ mide, cuando mide algo, es **compartición de un presupuesto de recursos** —eso lo tiene un portátil cuyo cómputo compite con su refrigeración por el mismo presupuesto eléctrico—. Si κ fuera la firma de la autopoiesis, mi computador estaría vivo. Peor: **ninguna de mis dos ramas es autopoiética**, pues en ambas la bomba es un parámetro exógeno que yo lesiono desde fuera; no hay clausura de producción ni adaptividad, que es lo que Di Paolo (2005) exige.
